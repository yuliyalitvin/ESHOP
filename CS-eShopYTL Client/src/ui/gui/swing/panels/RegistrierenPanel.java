...
/**
 * Layout und Funktionen der Registrieren Seite
 * 
...
public class RegistrierenPanel extends JPanel {
	...
	public RegistrierenPanel(EShopInterface verwaltung, RegistrierenListener listener) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!benutzerName.isEmpty() && !passwort.isEmpty() && !vorname.isEmpty() && !nachname.isEmpty()
					...
					try {
						...
						eShopInterface.fuegeKundeEin(benutzerName, true, passwort, vorname, nachname, strasse, plz, ort,
								land);
