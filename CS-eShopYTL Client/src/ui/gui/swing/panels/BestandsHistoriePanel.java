...
/**
 * Graphische Darstellenung der Bestandshistorie
 * 
...
public class BestandsHistoriePanel extends JPanel {
	...
	/**
	 * Historiegraph fuer einen Artikel aktualisieren
	 * 
	 * @param artikel,        Artikelobjekt
	 * @param eShopInterface, Objekt des EShopInterfaces
	 * @return bestandsVektor, gibt Tagesbestand zurueck
	 */
	public void aktualisiereBestandsHistorieGraph(Artikel artikel, EShopInterface eShopInterface) {
		int[] bestandsVektor = eShopInterface.getArtikelBestandsHistorieVector(artikel);
	...
	/**
	 * Graphische Oberflaeche fuer den Bestandsgraph erstellen
	 */
