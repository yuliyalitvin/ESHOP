...
public class Ereignis {
	...
	public Ereignis(int datumInput, int artikelNummerInput, int anzahlInput, int ereignisArtInput,
			int personIndexInput) {
		datum = datumInput;
		artikelNummer = artikelNummerInput;
		anzahl = anzahlInput;
		ereignisArt = ereignisArtInput;
		personIndex = personIndexInput;
	}
