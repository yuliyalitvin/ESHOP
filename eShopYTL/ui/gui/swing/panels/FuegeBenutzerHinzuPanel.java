...
import ui.gui.swing.panels.FuegeArtikelHinzuPanel.NumericKeyAdapter;
import ui.gui.swing.panels.FuegeArtikelHinzuPanel.buttonAktivieren;
...
public class FuegeBenutzerHinzuPanel extends JPanel {
	...
	public FuegeBenutzerHinzuPanel(Verwaltung verwaltung, BenutzerHinzufuegenListener listener) {
		eShop = verwaltung;
			...
			public void actionPerformed(ActionEvent actionEvent) {
				...
				if (!benutzername.isEmpty() && !passwort.isEmpty() && !vorname.isEmpty() && !nachname.isEmpty()) {
					try {
						...
						benutzer = eShop.fuegeMitarbeiterEin(benutzername, false, passwort, vorname, nachname);
