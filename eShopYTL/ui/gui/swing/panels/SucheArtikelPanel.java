...
public class SucheArtikelPanel extends JPanel {
	...
	public SucheArtikelPanel(Verwaltung verwaltung, SucheArtikelPanelListener listener) {
		eShop = verwaltung;
		...
		public void actionPerformed(ActionEvent actionEvent) {
			if (actionEvent.getSource().equals(suchButton)) {
				...
				if (gesuchtes.isEmpty()) {
					...
					try {
						suchErgebnis = eShop.sucheNachArtikelname(gesuchtes);
				...
				if (suchErgebnis != null) {
					sucheListener.beiSuchErgebnisArtikel(suchErgebnis);
				}
			}
		}
	}
