...
public class SucheBenutzerPanel extends JPanel {
	...
	public SucheBenutzerPanel(Verwaltung verwaltung, SucheBenutzerPanelListener listener) {
		eShop = verwaltung;
		...
		public void actionPerformed(ActionEvent actionEvent) {
			if (actionEvent.getSource().equals(suchButton)) {
				...
				if (gesuchtes.isEmpty()) {
					suchErgebnis = eShop.gibAlleBenutzer();
				} else {
					try {
						suchErgebnis = eShop.sucheBenutzerNachBenutzername(gesuchtes);
